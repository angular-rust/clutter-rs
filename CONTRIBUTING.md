...
```
git clone git@github.com:$USER/clutter-rs.git
```

where `$USER` is your GitHub username. Here you're copying the contents of the `clutter-rs` repository on GitHub to your computer.
