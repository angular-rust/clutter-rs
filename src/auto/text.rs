// Scriptable
use crate::{Actor, Animatable, Color, Container, Rect, TextBuffer};
use glib::{
    object as gobject,
...
glib_wrapper! {
    pub struct Text(Object<ffi::ClutterText, ffi::ClutterTextClass, TextClass>) @extends Actor, gobject::InitiallyUnowned, @implements Animatable, Container;
