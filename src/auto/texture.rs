...
pub trait TextureExt: 'static {
    ...
    fn get_property_filter_quality(&self) -> TextureQuality;

    fn set_property_filter_quality(&self, filter_quality: TextureQuality);
...
impl<O: IsA<Texture>> TextureExt for O {
    ...
    fn get_property_filter_quality(&self) -> TextureQuality {
        unsafe {
            let mut value = Value::from_type(<TextureQuality as StaticType>::static_type());
            gobject_sys::g_object_get_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"filter-quality\0".as_ptr() as *const _,
                value.to_glib_none_mut().0,
            );
            value
                .get()
                .expect("Return Value for property `filter-quality` getter")
                .unwrap()
        }
    }
    ...
    fn set_property_filter_quality(&self, filter_quality: TextureQuality) {
        unsafe {
            gobject_sys::g_object_set_property(
                self.to_glib_none().0 as *mut gobject_sys::GObject,
                b"filter-quality\0".as_ptr() as *const _,
                Value::from(&filter_quality).to_glib_none().0,
            );
        }
    }
